...
export const NOTES_GETNOTEID_REQUEST = "NOTES_GETNOTEID_REQUEST";
export const NOTES_GETNOTEID_SUCCESS = "NOTES_GETNOTEID_SUCCESS";
export const NOTES_GETNOTEID_FAIL = "NOTES_GETNOTEID_FAIL";
